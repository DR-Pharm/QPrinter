...
void PRT::createPix(QPixmap *pix)
{
	...
	lines.append(QLine(QPoint(edgeOffset, 505), QPoint(innerWidth, 505)));//重量明细下边

	lines.append(QLine(QPoint(420, 180), QPoint(420, 505)));//重量分析与每粒重量之间
	lines.append(QLine(QPoint(edgeOffset, innerHeight-80), QPoint(innerWidth, innerHeight-80)));//操作人签名上侧
	...
	painter->drawText(50, 50, innerWidth+1000, 70, Qt::AlignCenter, QString::fromLocal8Bit("设备型号/编号:"));
	...
	painter->drawText(420, 180, innerWidth-420, 60, Qt::AlignCenter, QString::fromLocal8Bit("每粒重量(g)"));
	//第四部分
	painter->drawText(50, 240, 200, 60, Qt::AlignCenter, QString::fromLocal8Bit("最大值(g):"));
	painter->drawText(50, 295, 200, 60, Qt::AlignCenter, QString::fromLocal8Bit("最小值(g):"));
	painter->drawText(50, 345, 200, 60, Qt::AlignCenter, QString::fromLocal8Bit("平均值(g):"));
	painter->drawText(50, 395, 200, 60, Qt::AlignCenter, QString::fromLocal8Bit("差异值(大):"));
	painter->drawText(50, 445, 200, 60, Qt::AlignCenter, QString::fromLocal8Bit("差异值(小):"));
	...
	//第五部分
	painter->drawText(50, innerHeight-80, 1000, 80, Qt::AlignCenter, QString::fromLocal8Bit("操作人:"));// +ui->lE_inspect->text());
	painter->drawText(50, innerHeight - 80, 1900, 80, Qt::AlignCenter, QString::fromLocal8Bit("复核人:"));// +ui->lE_code->text());

	painter->drawText(50, innerHeight - 80, 3000, 80, Qt::AlignCenter, QString::fromLocal8Bit("报告日期:"));// +ui->lE_reportDate->text());
